...
class RadarNowCast:
  ...
  def color_reduction(cls, rgb):
    table = {
      ...
      (255, 153,   0): (255, 153,   0), # âJâ_ 30-50mm/h
      (255, 255,   0): (255, 255,   0), # âJâ_ 20-30mm/h
      (  0, 255,   0): (  0, 255,   0), # âJâ_ 10-20mm/h
      (  0,   0, 255): (  0,   0, 255), # âJâ_  5-10mm/h
      ( 51, 102, 255): ( 51, 102, 255), # âJâ_  1- 5mm/h
      (153, 204, 255): (153, 204, 255), # âJâ_  0- 1mm/h
    }
